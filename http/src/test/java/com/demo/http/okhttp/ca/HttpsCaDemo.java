package com.demo.http.okhttp.ca;
...
@SpringBootTest
public class HttpsCaDemo {
 
    private static final Logger logger = LoggerFactory.getLogger(HttpsCaDemo.class);
    ...
    static {
        InputStream ca = HttpsCaDemo.class.getClassLoader().getResourceAsStream("client/ds.crt");
