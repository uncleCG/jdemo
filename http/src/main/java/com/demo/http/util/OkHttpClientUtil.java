...
/**
 * 原文：https://blog.csdn.net/justry_deng/article/details/91569132
 * OkHttpClient工具类
 * <p>
...
public class OkHttpClientUtil {
     ...
     * 确保本条指令不会因编译器的优化而省略，且要求每次直接读值
     */
    private static volatile OkHttpClient httpsClientVerifyCa;
    /**
     * ssl socket工厂（需要校验CA）
     */
    ...
    private static void initHttpsClient(boolean needVerifyCa, InputStream caInputStream, String caAlias)
        ...
        if (needVerifyCa) {
             ...
             * 设置hostname校验规则。
             */
            httpsClientVerifyCa = builder.build();
            return;
        }
        // 不需要校验证书
